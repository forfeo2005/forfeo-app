...
app.get('/entreprise/dashboard', async (req, res) => {
    ...
    try {
        ...
        res.render('entreprise-dashboard', { missions: missions.rows, userName: req.session.userName, stats: { totale: missions.rows.length, forfait: forfait, canPublish: (forfait !== 'Freemium' || missions.rows.length < 1) } });
