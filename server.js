...
app.post('/stripe-webhook', express.raw({type: 'application/json'}), async (req, res) => {
    ...
    if (event.type === 'checkout.session.completed') {
        ...
        await pool.query("UPDATE users SET is_premium = TRUE WHERE email = $1", [session.customer_details.email]);
    }
...
// --- LOGIQUE MISSIONS (Règle l'erreur Cannot POST /creer-mission) ---
...
// --- AUTHENTIFICATION (Règle l'erreur Cannot POST /login) ---
