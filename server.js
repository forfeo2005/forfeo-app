...
app.get('/admin/dashboard', async (req, res) => {
    ...
    const rapports = await pool.query("SELECT m.titre, m.rapport_ambassadeur, u.nom as entreprise_nom FROM missions m JOIN users u ON m.entreprise_id = u.id WHERE m.statut = 'termine' ORDER BY m.id DESC");
