...
// Clé Stripe avec guillemets pour éviter la ReferenceError
...
app.post('/register', async (req, res) => {
    ...
    try {
        await pool.query("INSERT INTO users (nom, email, password, role, ville) VALUES ($1, $2, $3, $4, $5)", 
...
app.post('/valider-mission', async (req, res) => {
    ...
    try {
        ...
        await transporter.sendMail({
            ...
            subject: `🚩 Rapport Mission ID: ${mission_id}`,
            text: `Un ambassadeur a soumis un rapport : ${rapport}`
        });
